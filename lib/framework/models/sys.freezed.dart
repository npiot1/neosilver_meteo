...
abstract class $SysCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int type, String country, int sunrise, int sunset});
}
...
class _$SysImpl implements _Sys {
  ...
  @override
  String toString() {
    return 'Sys(id: $id, type: $type, country: $country, sunrise: $sunrise, sunset: $sunset)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, type, country, sunrise, sunset);
